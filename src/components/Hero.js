        ...
        <section id="hero" >
            <div className="container">
                <div className="hero-left-container">
                    ...
                    <p className="about-me p-lineheight" >As a former engineering student and project manager who always ended up being the tech support person on a team, it became   obvious that I should make a change. While it wasn't the easiest decision, I am now happily pursuing my passions and am learning to code through online resources to create practical solutions for real-world problems and make a difference for those around me.</p>
                    <div className ="links">
